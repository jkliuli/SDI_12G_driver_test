source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_core_rst/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_sdi/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_phy_reset/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_sdi_clkout/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_phy/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_phy_reset_0/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_phy_rst_ctrl_clk/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/sdi_tx_sys/sdi_tx_sys_tx_phy_rst_ctrl/sim/common/modelsim_files.tcl]
...
namespace eval sdi_tx_sys {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/sdi_tx_sys.v"]\"  -work sdi_tx_sys"                                                                     
    return $design_files
  }
