-- sdi_tx_sys_tx_phy.vhd

-- Generated using ACDS version 22.2 94

library IEEE;
library altera_xcvr_native_a10_191;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;

entity sdi_tx_sys_tx_phy is
	port (
		...
		tx_control        : in  std_logic_vector(17 downto 0)  := (others => '0'); --        tx_control.tx_control
		tx_enh_data_valid : in  std_logic_vector(0 downto 0)   := (others => '0')  -- tx_enh_data_valid.tx_enh_data_valid
	);
end entity sdi_tx_sys_tx_phy;

architecture rtl of sdi_tx_sys_tx_phy is
	component sdi_tx_sys_tx_phy_altera_xcvr_native_a10_191_lnnghhq_cmp is
		generic (
			...
			adme_pma_mode                                                          : string  := "basic_enh";
			adme_tx_power_mode                                                     : string  := "low_power";
		...
		port (
			...
			ltssm_rcvr_equalization   : in  std_logic                      := 'X';             -- ltssm_rcvr_equalization
	...
	end component sdi_tx_sys_tx_phy_altera_xcvr_native_a10_191_lnnghhq_cmp;

	for tx_phy : sdi_tx_sys_tx_phy_altera_xcvr_native_a10_191_lnnghhq_cmp
		use entity altera_xcvr_native_a10_191.sdi_tx_sys_tx_phy_altera_xcvr_native_a10_191_lnnghhq;
begin

	tx_phy : component sdi_tx_sys_tx_phy_altera_xcvr_native_a10_191_lnnghhq_cmp
		generic map (
			...
			hssi_10g_rx_pcs_gb_rx_odwidth                                          => "width_32",
			...
			hssi_10g_rx_pcs_rxfifo_mode                                            => "generic_basic",
			hssi_10g_rx_pcs_rxfifo_pempty                                          => 2,
			hssi_10g_rx_pcs_rxfifo_pfull                                           => 10,
			...
			hssi_10g_tx_pcs_fifo_double_write                                      => "fifo_double_write_en",
			...
			hssi_10g_tx_pcs_gb_tx_idwidth                                          => "width_40",
			...
			hssi_fifo_tx_pcs_double_write_mode                                     => "double_write_en",
			...
			pma_adapt_datarate                                                     => "1000000000 bps",
			...
			cdr_pll_datarate                                                       => "1000000000 bps",
			cdr_pll_lpd_counter                                                    => 1,
			cdr_pll_lpfd_counter                                                   => 1,
			cdr_pll_n_counter_scratch                                              => 1,
			cdr_pll_output_clock_frequency                                         => "500000000 Hz",
			cdr_pll_reference_clock_frequency                                      => "50000000 Hz",
			cdr_pll_set_cdr_vco_speed                                              => 0,
			cdr_pll_set_cdr_vco_speed_fix                                          => 0,
			cdr_pll_vco_freq                                                       => "500000000 Hz",
			...
			pma_rx_buf_datarate                                                    => "1000000000 bps",
			...
			pma_rx_buf_xrx_path_datarate                                           => "1000000000 bps",
			pma_rx_buf_xrx_path_datawidth                                          => 40,
			pma_rx_buf_xrx_path_pma_rx_divclk_hz                                   => "50000000",
			pma_rx_deser_clkdiv_source                                             => "vco_bypass_normal",
			pma_rx_deser_clkdivrx_user_mode                                        => "clkdivrx_user_disabled",
			pma_rx_deser_datarate                                                  => "1000000000 bps",
			...
			pma_rx_dfe_datarate                                                    => "1000000000 bps",
			...
			pma_rx_odi_datarate                                                    => "1000000000 bps",
			...
			pma_tx_buf_datarate                                                    => "11880000000 bps",
			...
			pma_tx_buf_xtx_path_datarate                                           => "11880000000 bps",
			pma_tx_buf_xtx_path_datawidth                                          => 40,
			pma_tx_buf_xtx_path_clock_divider_ratio                                => 1,
			pma_tx_buf_xtx_path_pma_tx_divclk_hz                                   => "297000000",
			pma_tx_buf_xtx_path_tx_pll_clk_hz                                      => "500000000",
			...
			pma_cgb_datarate                                                       => "11880000000 bps",
			...
			hssi_rx_pcs_pma_interface_channel_operation_mode                       => "tx_rx_independent",
			...
			hssi_rx_pld_pcs_interface_hd_chnl_prot_mode_rx                         => "basic_10gpcs_rx",
			...
			hssi_rx_pld_pcs_interface_hd_chnl_channel_operation_mode               => "tx_rx_independent",
			...
			hssi_rx_pld_pcs_interface_hd_chnl_pma_rx_clk_hz                        => 0,
			hssi_rx_pld_pcs_interface_hd_chnl_pld_rx_clk_hz                        => 0,
			hssi_rx_pld_pcs_interface_hd_chnl_fref_clk_hz                          => 0,
			hssi_rx_pld_pcs_interface_hd_chnl_clklow_clk_hz                        => 0,
			hssi_rx_pld_pcs_interface_hd_fifo_channel_operation_mode               => "tx_rx_independent",
			...
			hssi_rx_pld_pcs_interface_hd_10g_channel_operation_mode                => "tx_rx_independent",
			...
			hssi_rx_pld_pcs_interface_hd_10g_prot_mode_rx                          => "basic_mode_rx",
			...
			hssi_rx_pld_pcs_interface_hd_8g_channel_operation_mode                 => "tx_rx_independent",
			...
			hssi_rx_pld_pcs_interface_hd_krfec_channel_operation_mode              => "tx_rx_independent",
			...
			hssi_rx_pld_pcs_interface_hd_pmaif_channel_operation_mode              => "tx_rx_independent",
			hssi_rx_pld_pcs_interface_hd_pmaif_sim_mode                            => "disable",
			hssi_rx_pld_pcs_interface_hd_pmaif_prot_mode_rx                        => "teng_basic_mode_rx",
			...
			hssi_tx_pcs_pma_interface_channel_operation_mode                       => "tx_rx_independent",
			...
			hssi_tx_pld_pcs_interface_hd_chnl_prot_mode_tx                         => "basic_10gpcs_tx",
			hssi_tx_pld_pcs_interface_hd_chnl_ctrl_plane_bonding_tx                => "individual_tx",
			hssi_tx_pld_pcs_interface_hd_chnl_pma_dw_tx                            => "pma_40b_tx",
			hssi_tx_pld_pcs_interface_hd_chnl_pld_fifo_mode_tx                     => "fifo_tx",
			hssi_tx_pld_pcs_interface_hd_chnl_shared_fifo_width_tx                 => "double_tx",
			hssi_tx_pld_pcs_interface_hd_chnl_low_latency_en_tx                    => "disable",
			hssi_tx_pld_pcs_interface_hd_chnl_func_mode                            => "enable",
			hssi_tx_pld_pcs_interface_hd_chnl_channel_operation_mode               => "tx_rx_independent",
			hssi_tx_pld_pcs_interface_hd_chnl_lpbk_en                              => "disable",
			hssi_tx_pld_pcs_interface_hd_chnl_frequency_rules_en                   => "enable",
			hssi_tx_pld_pcs_interface_hd_chnl_pma_tx_clk_hz                        => 297000000,
			hssi_tx_pld_pcs_interface_hd_chnl_pld_tx_clk_hz                        => 148500000,
			hssi_tx_pld_pcs_interface_hd_chnl_pld_uhsif_tx_clk_hz                  => 0,
			hssi_tx_pld_pcs_interface_hd_fifo_channel_operation_mode               => "tx_rx_independent",
			hssi_tx_pld_pcs_interface_hd_fifo_prot_mode_tx                         => "teng_mode_tx",
			hssi_tx_pld_pcs_interface_hd_fifo_shared_fifo_width_tx                 => "double_tx",
			hssi_tx_pld_pcs_interface_hd_10g_channel_operation_mode                => "tx_rx_independent",
			hssi_tx_pld_pcs_interface_hd_10g_lpbk_en                               => "disable",
			hssi_tx_pld_pcs_interface_hd_10g_advanced_user_mode_tx                 => "disable",
			hssi_tx_pld_pcs_interface_hd_10g_pma_dw_tx                             => "pma_40b_tx",
			hssi_tx_pld_pcs_interface_hd_10g_fifo_mode_tx                          => "fifo_tx",
			hssi_tx_pld_pcs_interface_hd_10g_prot_mode_tx                          => "basic_mode_tx",
			hssi_tx_pld_pcs_interface_hd_10g_low_latency_en_tx                     => "disable",
			hssi_tx_pld_pcs_interface_hd_10g_shared_fifo_width_tx                  => "double_tx",
			hssi_tx_pld_pcs_interface_hd_8g_channel_operation_mode                 => "tx_rx_independent",
			...
			hssi_tx_pld_pcs_interface_hd_krfec_channel_operation_mode              => "tx_rx_independent",
			...
			hssi_tx_pld_pcs_interface_hd_pmaif_channel_operation_mode              => "tx_rx_independent",
			hssi_tx_pld_pcs_interface_hd_pmaif_sim_mode                            => "disable",
			hssi_tx_pld_pcs_interface_hd_pmaif_prot_mode_tx                        => "teng_basic_mode_tx",
			hssi_tx_pld_pcs_interface_hd_pmaif_pma_dw_tx                           => "pma_40b_tx",
		...
		port map (
			...
			ltssm_rcvr_equalization   => '0',                                                                --       (terminated)
			...
			reconfig_clk              => "0",                                                                --       (terminated)
			reconfig_reset            => "0",                                                                --       (terminated)
			reconfig_write            => "0",                                                                --       (terminated)
			reconfig_read             => "0",                                                                --       (terminated)
			reconfig_address          => "0000000000",                                                       --       (terminated)
			reconfig_writedata        => "00000000000000000000000000000000",                                 --       (terminated)
			reconfig_readdata         => open,                                                               --       (terminated)
			reconfig_waitrequest      => open,                                                               --       (terminated)
			avmm_busy                 => open                                                                --       (terminated)
		);

end architecture rtl; -- of sdi_tx_sys_tx_phy
