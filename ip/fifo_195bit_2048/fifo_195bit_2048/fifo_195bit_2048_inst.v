	fifo_195bit_2048 u0 (
		.data    (_connected_to_data_),    //   input,  width = 195,  fifo_input.datain
		...
		.q       (_connected_to_q_),       //  output,  width = 195, fifo_output.dataout
		.rdusedw (_connected_to_rdusedw_), //  output,   width = 11,            .rdusedw
		.wrusedw (_connected_to_wrusedw_), //  output,   width = 11,            .wrusedw
